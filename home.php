...
<body>
    ...
    <div id="main">
            ...
            <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
                ...
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <img src="./assets/img/base/banner_web_1.webp" class="d-block w-100" alt="...">
                    </div>
                    <div class="carousel-item">
                        <img src="./assets/img/base/banner_web_2.webp" class="d-block w-100" alt="...">
                    </div>
                    <div class="carousel-item">
                        <img src="./assets/img/base/banner_web_3.webp" class="d-block w-100" alt="...">
                    </div>
                </div>
        ...
        <!-- item-focus -->
        <div class="itemsFocus__wrap">
            <div class="itemsFocus">
                <div class="itemFirst">
                    <div class="itemFirst__desc">
                        <h3 class="itemFirst__desc-title">
                            Trà Sen Nhãn Sum Vầy
                        </h3>
                        ...
                        <!-- 1 -->
                        <div class="itemsFirst__desc-btn">
                            Tìm hiểu thêm
                        </div>
                    </div>
                    <div class="itemFirst__img">
                        <img src="./assets/img/items-hot/IF-first.png" alt="">
                    </div>
                </div>
                <div class="itemSecond">
                    <div class="itemSecond__desc">
                        <h3 class="itemSecond__desc-title">
                            Trà Dưa Đào Sung Túc
                        </h3>
                        ...
                        <!-- 2 -->
                        <div class="itemsSecond__desc-btn">
                            Tìm hiểu thêm
                        </div>
                    </div>
                    <div class="itemSecond__img">
                        <img src="./assets/img/items-hot/IF-second.png" alt="">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="store__wrap">
            <div class="store">
                <div class="store__content-wrap">
                    <div class="store__desc">
                        <h3 class="store__desc-title">
                            The Coffee House 92 Lê Thanh Nghị - Hà Nội
                        </h3>
                        <div class="store__desc-content">
                            Nhà Lê Thanh Nghị có thật nhiều khung cửa kính lớn đón nắng và ấm áp với tông nâu, hiện đại - thanh lịch; không "đụng hàng" bất kì nhà nào ở Hà Nội
                        </div>
                        <div class="store__desc-btn">
                            Tìm hiểu thêm
                        </div>
                    </div>
                    <div class="store__slide-img">
                        <!-- slideshow -->
                        <div class="store__slide-item" style="background: url('./assets/img/items-hot/store_slide-1.jpg') center/cover no-repeat;"></div>
                        <div class="store__slide-item hidden" style="background: url('./assets/img/items-hot/store_slide-2.jpg') center/cover no-repeat;"></div>
                        <div class="store__slide-item hidden" style="background: url('./assets/img/items-hot/store_slide-3.jpg') center/cover no-repeat;"></div>
                        <div class="store__slide-item hidden" style="background: url('./assets/img/items-hot/store_slide-4.jpg') center/cover no-repeat;"></div>
                        <!--  -->
                        <div class="store__slide-btnNext">
                            <i class="fa-solid fa-caret-right"></i>
                        </div>
                        <div class="store__slide-btnPrev">
                            <i class="fa-solid fa-caret-left"></i>
                        </div>
                        <div class="store__slide-listDot">
                            <i class="fa-solid fa-circle dot__active"></i>
        ...
        <div class="blog__wrap">
            <div class="blog">
                <div class="blog__titlewrap">
                    <div class="blog__title-slogan">
                        <img src="./assets/img/items-hot/blog_titleIMG.jpg" alt="">
                    </div>
                    <h2 class="blog__title">Chuyện Cà phê và Trà</h2>
                </div>
                <!-- blog coffee -->
                <div class="blog__coffee">
