...
(254, 'admin@gmail.com', 1, '2023-05-19 23:32:41'),
(255, 'admin@gmail.com', 1, '2023-05-19 23:32:41'),
(256, 'admin@gmail.com', 1, '2023-05-19 23:32:41'),
(257, 'admin@gmail.com', 2, '2023-05-19 23:32:41');
...
(6, '', NULL, '', NULL, 'huy12@support.com', NULL, '');
...
(99, './assets/img/menu/TTN12.jpg', 'Trà Sen Lá Tearoma 100gr', 80000, 12, 'code bửn quá :v'),
(100, './assets/img/menu/TTN13.jpg', 'Trà Oolong Lá Tearoma 100gr', 100000, 12, 'ước gì học php hẳn hoi >.<\"'),
(101, './assets/img/menu/TTN14.jpg', 'Trà Lài Lá Tearoma 100gr', 80000, 12, 'Code nhiều lỗi vl :v ');
...
('admin@gmail.com', 'admin', '$2y$10$T0bTmNPeh3mcaNWW0uH2R.OIeYtsI84iDRY0/TXwtpWViCiKWf8hu', 1),
('huy12@support.com', 'huy12', '$2y$10$ZO9MxKybyZAGTFhezi2SdOgALijf6fTB4TmeyOwm/z1MeDo16FIry', 1),
('minh@gmail.com', 'minh', '$2y$10$XPFT.ts6Luw52KdsoqgjA.k6NT.CKXeZWKVMjagAMDyQ63UaKMqUe', 3);
...
(67, 'admin@gmail.com', 'Thanh toán khi nhận hàng', '2023-05-19 23:32:41', '286155', '122000'),
(68, 'admin@gmail.com', 'Thanh toán khi nhận hàng', '2023-05-19 23:33:01', '913262', '122000');
...
--
ALTER TABLE `cart`
  MODIFY `number` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=258;
...
--
ALTER TABLE `user_order`
  MODIFY `confirm_cart_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=69;
